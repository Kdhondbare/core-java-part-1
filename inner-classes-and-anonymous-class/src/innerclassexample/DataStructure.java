...
public class DataStructure {
    ...
    // It can have all access level, e.g. private, default, protected, package.
    ...
    public static void main(String[] args) {
        ...
        Printer printer = dataStructure.new Printer();//then use outer class object to create inner class object
        printer.display();
