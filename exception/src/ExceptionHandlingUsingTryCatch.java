...
public class ExceptionHandlingUsingTryCatch {
    public static void main(String[] args) {
        ...
        int b= 0;
        int c= 0;
        //the statements that cause an exception must be put inside try block and should have a catch block to catch exception
        //if an exception occurs then associated catch block is called and normal flow gets executed.
