public class Main {
    ...
    public static void changeCarReference(Car carRef) {
        ...
        /*
        This will change the brand name of car object at 1000h in heap to Toyota
         */
        ...
        as of myCar reference and changed the brand name of car objece at 1000h to Toyota
         */
